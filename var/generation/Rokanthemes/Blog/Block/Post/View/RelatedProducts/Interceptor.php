...
class Interceptor extends \Rokanthemes\Blog\Block\Post\View\RelatedProducts implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayProducts');
        if (!$pluginInfo) {
            return parent::displayProducts();
        } else {
            return $this->___callPlugins('displayProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPost()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getPost', func_get_args(), $pluginInfo);
        }
    }
