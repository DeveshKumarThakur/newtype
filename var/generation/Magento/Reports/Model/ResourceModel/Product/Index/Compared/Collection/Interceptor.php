...
class Interceptor extends \Magento\Reports\Model\ResourceModel\Product\Index\Compared\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIndexFilter');
        if (!$pluginInfo) {
            return parent::addIndexFilter();
        } else {
            return $this->___callPlugins('addIndexFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByIds');
        if (!$pluginInfo) {
            return parent::addFilterByIds($ids);
        } else {
            return $this->___callPlugins('addFilterByIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAddedAtOrder');
        if (!$pluginInfo) {
            return parent::setAddedAtOrder($dir);
        } else {
            return $this->___callPlugins('setAddedAtOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'excludeProductIds');
        if (!$pluginInfo) {
            return parent::excludeProductIds($productIds);
        } else {
            return $this->___callPlugins('excludeProductIds', func_get_args(), $pluginInfo);
        }
    }
