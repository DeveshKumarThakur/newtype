...
class Interceptor extends \Magento\CatalogSearch\Model\ResourceModel\Search\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addSearchFilter($query)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('addSearchFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addBackendSearchFilter');
        if (!$pluginInfo) {
            return parent::addBackendSearchFilter($query);
        } else {
            return $this->___callPlugins('addBackendSearchFilter', func_get_args(), $pluginInfo);
        }
    }
