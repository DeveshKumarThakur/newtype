    ...
    $.widget('mage.SwatchRenderer', {
        ...
        updateBaseImage: function (images, context, isProductViewExist) {
            ...
            if (isProductViewExist && justAnImage && justAnImage.img) {
                context.find('[data-gallery-role=gallery-placeholder] .main-img-quickview a.cloud-zoom').attr('href', justAnImage.full);
                context.find('[data-gallery-role=gallery-placeholder] .main-img-quickview a.cloud-zoom img').attr('src', justAnImage.img);
				...
				for(var i = 0; i < images.length; i++)
				{
					...
					if(i==0)
						active = ' active';
					html.push('<li class="small_image'  + active + '">');
					html.push('<img data-href="'+ images[i].full +'" data-thumb-image="'+ images[i].img +'" src="'+ images[i].thumb +'" />');
					html.push('</li>');
				}
				html.push('</ul>');
				context.find('[data-gallery-role=gallery-placeholder] > div.row').html(html.join(''));
				$('.cloud-zoom, .cloud-zoom-gallery').CloudZoom();
				context.find('[data-gallery-role=gallery-placeholder] > div.row .owl').owlCarousel({
					autoPlay : false,
					items : 4,
					itemsDesktop : [1199,4],
