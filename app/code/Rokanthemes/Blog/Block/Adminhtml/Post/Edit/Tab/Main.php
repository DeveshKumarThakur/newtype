...
namespace Rokanthemes\Blog\Block\Adminhtml\Post\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
         ...
         */
        $isElementDisabled = !$this->_isAllowedAction('Rokanthemes_Blog::post');
        ...
        $this->_eventManager->dispatch('rokanthemes_blog_post_edit_tab_main_prepare_form', ['form' => $form]);
